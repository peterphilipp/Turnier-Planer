...
import { getShifts, createShift, createShiftSchema, deleteShift, updateShift, updateShiftSchema, updateShiftsBatch, updateShiftsBatchSchema } from '../controllers/shift.controller.js';
...
router.post('/', authenticate, requireAdmin, validate(createShiftSchema), createShift);
