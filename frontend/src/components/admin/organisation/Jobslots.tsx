...
import { getShifts, getWorkAreas, getGlobalTimeSlots, apiPost, apiPatch, apiDelete } from '../../../api';
import { btnStyleSecondary, tdStyle, thStyle, btnStyle, inputStyle, Shift, WorkArea, GlobalTimeSlot, Tournament } from '../shared';
