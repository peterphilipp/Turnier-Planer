...
import { getClubs, apiPost, apiDelete } from '../../../api';
          ...
          {availableClubs.map(club => (
            <label 
              ...
              style={{ 
                ...
                gap: 10, 
                padding: '12px 16px', 
                background: selectedClubIds.includes(club.id) ? '#e7f3ff' : '#f8f9fa',
                border: `2px solid ${selectedClubIds.includes(club.id) ? '#0d6efd' : '#dee2e6'}`,
                borderRadius: 10, 
                cursor: 'pointer',
                transition: 'all 0.2s'
              }}
