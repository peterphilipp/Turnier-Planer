...
export interface Tournament { id: number; name: string; startDate: string; endDate: string; status: string; turnierModus: string; clubId: number | null; club: { id: number; name: string; logo: string | null; primaryColor: string; secondaryColor: string; accentColor: string } | null; }
...
export interface Team { id: number; name: string; groupId: number; tournamentId: number | null; goalsFor: number; goalsAgainst: number; group?: Group | null; }
