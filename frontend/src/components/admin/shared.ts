...
export interface FoodDonationSlot { id: number; tournamentId: number; yearGroup: string; foodItemId: number | null; targetQuantity: number; collected: number; description: string | null; tournament?: { id: number; name: string }; foodItem?: { id: number; categoryId: number; name: string; icon: string; unit: string }; }
