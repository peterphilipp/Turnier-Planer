...
export interface Match { id: number; tournamentId: number; yearGroupId: number | null; timeSlotId: number | null; fieldId: number | null; teamAId: number; teamBId: number; scoreA: number | null; scoreB: number | null; phase: string; status: string; time: string; teamA?: Team | null; teamB?: Team | null; timeSlot?: TimeSlot | null; field?: Field | null; }
